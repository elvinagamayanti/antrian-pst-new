...
import com.antrian.app.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/konfigurasi/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/statistik/**").hasRole("ADMIN")

                        // Admin & Operator
                        .requestMatchers("/api/antrian/**").hasAnyRole("ADMIN", "OPERATOR")
